...
class CircleModuleDrawer(StyledPilQRModuleDrawer):
    ...
    circle = None
    def __init__(self, resample_method=Resampling.LANCZOS):
...
class RoundedModuleDrawer(StyledPilQRModuleDrawer):
    ...
    def __init__(self, radius_ratio=1, resample_method=Resampling.LANCZOS):
...
class VerticalBarsDrawer(StyledPilQRModuleDrawer):
    ...
    def __init__(self, horizontal_shrink=0.8, resample_method=Resampling.LANCZOS):
...
class HorizontalBarsDrawer(StyledPilQRModuleDrawer):
    ...
    def __init__(self, vertical_shrink=0.8, resample_method=Resampling.LANCZOS):
